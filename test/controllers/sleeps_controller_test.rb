...
class SleepsControllerTest < ActionController::TestCase
  ...
  test "should create sleep" do
    assert_difference('Sleep.count') do
      post :create, sleep: { end_time: @sleep.end_time, start_time: @sleep.start_time, user_id: @sleep.user_id }
    end
  ...
  test "should update sleep" do
    patch :update, id: @sleep, sleep: { end_time: @sleep.end_time, start_time: @sleep.start_time, user_id: @sleep.user_id }
    assert_redirected_to sleep_path(assigns(:sleep))
  end
